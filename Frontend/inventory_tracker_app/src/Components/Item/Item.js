...
export default function Item({ itemInfo, checkedItems, setCheckedItems }) {
  ...
  return (
    <Card
      sx={{ backgroundColor: "#052354", color: "white" }}
    ...
    >
      <CardContent>
        <Checkbox
          onClick={() => {
            ...
            if (isChecked.current) {
              //If it is selected, addToCheckedList
              addToCheckedItems();
            } else {
              //Go through selected list and remove it's info from it
        ...
        <Typography
          ref={nameRef}
          onClick={() => viewDetails && setNameClicked(true)}
        ...
        {viewDetails ? (
          ...
          <Grid justifyContent="center" container>
            <Grid xs={12} md={12} lg={12} item>
              <Typography
                align="center"
                sx={{ fontWeight: "bold", paddingTop: "0.25em" }}
                variant="h6"
              >
                Quantity
              </Typography>
